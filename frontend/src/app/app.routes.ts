...
export const routes: Routes = [
    { path: '', pathMatch: 'full', redirectTo: 'resender' },
    {
        path: 'resender',
        canActivate: [AuthGuard],
        children: [
            { path: '', loadComponent: () => import('./dashboard/dashboard.component').then(m => m.DashboardComponent) },
            { path: 'site/:siteId/dashboard', loadComponent: () => import('./dashboard/site-dashboard.component').then(m => m.SiteDashboardComponent) },
            ...
            { path: 'analytics/coverage', loadComponent: () => import('./analytics/coverage.component').then(m => m.CoverageComponent) },
