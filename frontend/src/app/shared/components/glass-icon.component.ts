    ...
    <svg
      ...
      <ng-container [ngSwitch]="name">
        ...
        <g *ngSwitchCase="'insights'">
          ...
          <path d="M5 17l4-5 4 3 4-7" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        </g>
        ...
        <g *ngSwitchCase="'file_copy'">
          <path d="M8 4H6a2 2 0 00-2 2v14a2 2 0 002 2h10a2 2 0 002-2v-2" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
        ...
        <g *ngSwitchCase="'hourglass_empty'">
          <path d="M6 2h12M6 22h12M6 2v5l6 5-6 5v5M18 2v5l-6 5 6 5v5" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        </g>
        ...
        <g *ngSwitchCase="'wifi_tethering'">
          <circle cx="12" cy="12" r="2" fill="currentColor"/>
          <path d="M8.5 8.5a5 5 0 000 7M15.5 8.5a5 5 0 010 7" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
          <path d="M5.5 5.5a9 9 0 000 13M18.5 5.5a9 9 0 010 13" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
        </g>
        ...
        <g *ngSwitchCase="'autorenew'">
          <path d="M12 6V3l-4 4 4 4V8a6 6 0 016 6 6 6 0 01-1.05 3.39" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
          <path d="M12 18v3l4-4-4-4v3a6 6 0 01-6-6 6 6 0 011.05-3.39" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        </g>
