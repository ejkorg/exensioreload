...
@Component({
  ...
  template: `
    <div class="container glass-panel">
      <glass-loading-overlay
        ...
        subtext="Fetching session history and details."
      ></glass-loading-overlay>
                ...
                <div class="progress-wrap">
                  <div class="progress-bar-track">
                    <div
                      ...
                      [class]="getProgressClass(session)"
      ...
      <div class="pagination" *ngIf="total() > 0">
        ...
        <span class="pagination-info">
          ...
          <span class="pagination-range"
            >({{ paginationRangeStart() }}–{{ paginationRangeEnd() }} of {{ total() }})</span
          >
        </span>
        <button
          class="page-btn"
  ...
  styles: [
    `
      ...
      :host-context(body.light-theme) .filter-badge {
        background: rgba(79, 70, 229, 0.12);
        color: #4f46e5;
      }
      :host-context(body.light-theme) .filter-input,
      :host-context(body.light-theme) .filter-select,
      :host-context(body.light-theme) .page-size-select {
      ...
      :host-context(body.light-theme) .filter-select option,
      :host-context(body.light-theme) .page-size-select option {
        background: #ffffff;
        color: #1e293b;
      }
      :host-context(body.light-theme) .filter-input::placeholder {
        color: #64748b;
      }
      ...
      :host-context(body.light-theme) .table-wrap {
        border-color: rgba(99, 102, 241, 0.18);
        background: rgba(255, 255, 255, 0.6);
      }
      :host-context(body.light-theme) .hub-table th {
        background: rgba(99, 102, 241, 0.08);
        color: #4f46e5;
        border-bottom: 1px solid rgba(99, 102, 241, 0.15);
      }
      :host-context(body.light-theme) .hub-table td {
        border-bottom: 1px solid rgba(0, 0, 0, 0.06);
        color: var(--text-main);
      }
      :host-context(body.light-theme) .hub-table tbody tr:hover {
        background: linear-gradient(135deg, rgba(79, 70, 229, 0.08) 0%, rgba(14, 165, 233, 0.05) 100%);
      }
      :host-context(body.light-theme) .hub-table tbody tr.active {
        background: rgba(79, 70, 229, 0.07);
        border-left-color: rgba(79, 70, 229, 0.5);
      }
      :host-context(body.light-theme) .session-id-cell {
        color: #4f46e5;
      }
      :host-context(body.light-theme) .date-cell {
        color: #64748b;
      }
      :host-context(body.light-theme) .progress-pct {
        color: #64748b;
      }
      :host-context(body.light-theme) .pagination-info {
        color: #64748b;
      }
      :host-context(body.light-theme) .pagination-info strong {
        color: #1e293b;
      }
      :host-context(body.light-theme) .table-count {
        color: #64748b;
      }
      :host-context(body.light-theme) .page-size-label {
        color: #64748b;
      }
      ...
      :host-context(body.light-theme) .coverage-banner {
        background: linear-gradient(135deg, rgba(2, 132, 199, 0.07) 0%, rgba(79, 70, 229, 0.08) 100%);
        border-color: rgba(2, 132, 199, 0.25);
      }
      :host-context(body.light-theme) .coverage-icon {
        color: #0284c7;
      }
      :host-context(body.light-theme) .coverage-label {
        color: #0284c7;
      }
      :host-context(body.light-theme) .coverage-date {
        color: #1e293b;
      }
      :host-context(body.light-theme) .coverage-date--from {
        color: #4f46e5;
      }
      :host-context(body.light-theme) .coverage-date--to {
        color: #059669;
      }
      :host-context(body.light-theme) .coverage-arrow {
        color: #94a3b8;
      }
      :host-context(body.light-theme) .coverage-span {
        color: #64748b;
      }
      :host-context(body.light-theme) .coverage-hint {
        color: #64748b;
      }
      .charts-section {
        display: flex;
      ...
      .date-picker-btn {
        ...
        border-radius: 8px;
        border: 1px solid rgba(167, 139, 250, 0.24);
        background: rgba(67, 56, 132, 0.45);
        color: rgba(226, 232, 255, 0.95);
        cursor: pointer;
      }
      ...
      .preset-btn {
        ...
        border-radius: 999px;
        border: 1px solid rgba(167, 139, 250, 0.24);
        background: rgba(67, 56, 132, 0.38);
      ...
      .heatmap-row {
        display: grid;
        grid-template-columns: 92px repeat(7, minmax(26px, 1fr));
        gap: 0.25rem;
        align-items: center;
        min-width: 520px;
      }
      ...
      .files-section-header:hover {
        background: rgba(67, 50, 120, 0.65);
      }
      .files-section-title {
        display: flex;
        align-items: center;
      ...
      .ft-page-btn:hover:not(:disabled) {
        border-color: rgba(167, 139, 250, 0.48);
        background: rgba(99, 102, 241, 0.32);
      }
      ...
      :host-context(body.light-theme) .ft-pagination {
        border-top-color: rgba(99, 102, 241, 0.12);
        background: rgba(240, 238, 255, 0.4);
      }
      :host-context(body.light-theme) .ft-page-btn {
        border-color: rgba(99, 102, 241, 0.2);
        background: rgba(99, 102, 241, 0.08);
        color: #334155;
      }
      :host-context(body.light-theme) .ft-page-btn:hover:not(:disabled) {
        border-color: rgba(99, 102, 241, 0.4);
        background: rgba(99, 102, 241, 0.16);
      }
      :host-context(body.light-theme) .ft-page-info {
        color: #64748b;
      }
      :host-context(body.light-theme) .ft-page-info strong {
        color: #1e293b;
      }
      :host-context(body.light-theme) .files-section {
        border-color: rgba(99, 102, 241, 0.18);
      }
      :host-context(body.light-theme) .files-section-header {
        background: rgba(99, 102, 241, 0.1);
      }
      :host-context(body.light-theme) .files-section-header:hover {
        background: rgba(99, 102, 241, 0.16);
      }
      :host-context(body.light-theme) .files-section-title {
        color: #1e293b;
      }
      :host-context(body.light-theme) .files-count-badge {
        background: rgba(79, 70, 229, 0.12);
        color: #4f46e5;
      }
      :host-context(body.light-theme) .files-toggle-hint {
        color: #94a3b8;
      }
      :host-context(body.light-theme) .files-table-container {
        background: rgba(255, 255, 255, 0.7);
      }
      :host-context(body.light-theme) .files-toolbar {
        border-bottom-color: rgba(99, 102, 241, 0.12);
      }
      :host-context(body.light-theme) .files-search-input,
      :host-context(body.light-theme) .files-status-filter {
        border-color: rgba(99, 102, 241, 0.2);
      ...
      :host-context(body.light-theme) .files-search-input::placeholder {
        color: #94a3b8;
      }
      :host-context(body.light-theme) .files-showing {
        color: #94a3b8;
      }
      :host-context(body.light-theme) .files-table th {
        background: rgba(240, 238, 255, 0.95);
        color: #4f46e5;
        border-bottom-color: rgba(99, 102, 241, 0.15);
      }
      :host-context(body.light-theme) .files-table td {
        border-bottom-color: rgba(0, 0, 0, 0.05);
        color: #1e293b;
      }
      :host-context(body.light-theme) .files-table tbody tr:hover {
        background: rgba(79, 70, 229, 0.05);
      }
      :host-context(body.light-theme) .ft-row-odd {
        background: rgba(99, 102, 241, 0.03);
      }
      :host-context(body.light-theme) .ft-mono {
        color: #4f46e5;
      }
      :host-context(body.light-theme) .ft-filename {
        color: #334155;
      }
      :host-context(body.light-theme) .ft-date {
        color: #64748b;
      }
      :host-context(body.light-theme) .ft-endtime {
        color: #059669;
      }
      ...
      :host-context(body.light-theme) .detail-overlay {
        background:
          radial-gradient(1100px 380px at 50% 0%, rgba(99, 102, 241, 0.16), rgba(15, 23, 42, 0.26) 58%),
          rgba(15, 23, 42, 0.34);
      }
      :host-context(body.light-theme) .section-toggle {
        border: 1px solid rgba(99, 102, 241, 0.2);
        background: rgba(99, 102, 241, 0.1);
        color: #334155;
      }
      :host-context(body.light-theme) .section-toggle:hover {
        border-color: rgba(99, 102, 241, 0.4);
        background: rgba(99, 102, 241, 0.16);
      }
      :host-context(body.light-theme) .toggle-chevron {
        color: #4f46e5;
      }
      :host-context(body.light-theme) .detail-table-wrap {
        background: rgba(99, 102, 241, 0.06);
        border: 1px solid rgba(99, 102, 241, 0.18);
      }
      :host-context(body.light-theme) .detail-table-wrap .hub-table th {
        background: rgba(99, 102, 241, 0.08);
        border-bottom: 1px solid rgba(99, 102, 241, 0.12);
      }
      :host-context(body.light-theme) .detail-table-wrap .hub-table tbody tr:nth-child(even) {
        background: rgba(99, 102, 241, 0.04);
      }
      :host-context(body.light-theme) .charts-panel {
        border: 1px solid rgba(99, 102, 241, 0.18);
        background: rgba(99, 102, 241, 0.06);
      }
      :host-context(body.light-theme) .charts-head h4 {
        color: #1e293b;
      }
      :host-context(body.light-theme) .charts-sub {
        color: #64748b;
      }
      :host-context(body.light-theme) .analytics-toolbar {
        border: 1px solid rgba(99, 102, 241, 0.18);
        background: rgba(99, 102, 241, 0.06);
      }
      :host-context(body.light-theme) .toolbar-divider {
        background: rgba(99, 102, 241, 0.2);
      }
      :host-context(body.light-theme) .date-input-wrap {
        color: #64748b;
      }
      :host-context(body.light-theme) .date-input-wrap input {
        border: 1px solid rgba(99, 102, 241, 0.22);
        background: rgba(255, 255, 255, 0.88);
        color: #1e293b;
      }
      :host-context(body.light-theme) .date-picker-btn {
        border: 1px solid rgba(99, 102, 241, 0.22);
        background: rgba(99, 102, 241, 0.1);
        color: #334155;
      }
      :host-context(body.light-theme) .date-picker-btn:hover {
        border-color: rgba(99, 102, 241, 0.42);
        background: rgba(99, 102, 241, 0.18);
      }
      :host-context(body.light-theme) .preset-btn {
        border: 1px solid rgba(99, 102, 241, 0.22);
        background: rgba(99, 102, 241, 0.08);
        color: #334155;
      }
      :host-context(body.light-theme) .preset-btn:hover {
        border-color: rgba(99, 102, 241, 0.42);
        background: rgba(99, 102, 241, 0.16);
      }
      :host-context(body.light-theme) .summary-pill--completed {
        background: rgba(5, 150, 105, 0.12);
        border-color: rgba(5, 150, 105, 0.25);
        color: #059669;
      }
      :host-context(body.light-theme) .summary-pill--failed {
        background: rgba(220, 38, 38, 0.1);
      ...
      :host-context(body.light-theme) .chart-card {
        border: 1px solid rgba(99, 102, 241, 0.2);
        background: rgba(255, 255, 255, 0.82);
        box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.95);
      }
      :host-context(body.light-theme) .chart-title {
        color: #334155;
      }
      :host-context(body.light-theme) .chart-empty {
        color: #64748b;
      }
      :host-context(body.light-theme) .trend-day,
      :host-context(body.light-theme) .trend-total {
        color: #475569;
      }
      :host-context(body.light-theme) .trend-stack {
        background: rgba(148, 163, 184, 0.24);
      }
      :host-context(body.light-theme) .heatmap-head span {
        color: #64748b;
      }
      :host-context(body.light-theme) .heatmap-label {
        color: #334155;
      }
      :host-context(body.light-theme) .heatmap-cell {
        color: #ffffff;
      }
      :host-context(body.light-theme) .heatmap-hint {
        color: #64748b;
      }
      .detail-head {
        display: flex;
      ...
      :host-context(body.light-theme) .head-updated {
        color: #64748b;
      }
      :host-context(body.light-theme) .detail-head h3 {
        color: var(--text-main);
      }
      .actions {
        display: flex;
      ...
      :host-context(body.light-theme) .metric-card--total {
        background: rgba(99, 102, 241, 0.08);
        border-color: rgba(99, 102, 241, 0.2);
        color: #4f46e5;
      }
      :host-context(body.light-theme) .metric-card--staged {
        background: rgba(99, 102, 241, 0.08);
        border-color: rgba(99, 102, 241, 0.2);
        color: #4f46e5;
      }
      :host-context(body.light-theme) .metric-card--enqueued {
        background: rgba(217, 119, 6, 0.08);
        border-color: rgba(217, 119, 6, 0.2);
        color: #d97706;
      }
      :host-context(body.light-theme) .metric-card--done {
        background: rgba(5, 150, 105, 0.08);
        border-color: rgba(5, 150, 105, 0.2);
        color: #059669;
      }
      :host-context(body.light-theme) .metric-card--failed {
        background: rgba(220, 38, 38, 0.08);
      ...
      :host-context(body.light-theme) .detail-head {
      ...
      .files tbody tr:hover {
        ...
        box-shadow:
          0 20px 40px rgba(0, 150, 255, 0.08),
      ...
      :host-context(body.light-theme) .files tbody tr:hover td {
      ...
      @media (max-width: 768px) {
        ...
        .heatmap-head,
        .heatmap-row {
          grid-template-columns: 84px repeat(5, minmax(24px, 1fr));
        }
        .detail-table-wrap {
          max-height: 50vh;
        }
...
export class MySessionsComponent implements OnInit, OnDestroy {
  ...
  userFilterOptions = computed(() => {
    ...
    const users = Array.from(
      new Set(source.map((s: StagingSessionSummary) => (s.username || '').trim()).filter((u: string) => u.length > 0)),
    );
  ...
  lotWaferHeatmap = computed(() => {
    ...
    const pairs = Array.from(
      new Set(points.map((p: SessionLotWaferDailyPoint) => `${p.lot || '-'} / ${p.wafer || '-'}`)),
    );
    const days = Array.from(new Set(points.map((p: SessionLotWaferDailyPoint) => p.day))).sort((a, b) =>
      a.localeCompare(b),
    );
  ...
  fileCoverage = computed(() => {
    ...
    const days = Number.isFinite(fromMs) && Number.isFinite(toMs) ? Math.round((toMs - fromMs) / 86400000) : 0;
    return {
      from: fromKey,
      to: toKey,
      days,
  ...
  loadSessions() {
    this.backend
      .getStagingSessions(this.page(), this.size(), {
        ...
        devices: this.deviceFilter().length > 0 ? this.deviceFilter() : undefined,
      })
          ...
          list.map((s) =>
            s.sessionId === sessionId
              ? {
                  ...
                  filesDone: detail.filesDone,
                  filesFailed: detail.filesFailed,
  ...
  filesPrevPage() {
    if (this.filesPage() > 0) this.filesPage.update((v: number) => v - 1);
  }
  filesNextPage() {
    if (this.filesPage() < this.filesTotalPages() - 1) this.filesPage.update((v: number) => v + 1);
  }
  ...
  private buildFallbackAnalytics(sessionId: string): SessionAnalyticsResponse {
    ...
    const byDay = new Map<
      string,
      { done: number; enqueued: number; failed: number; cancelled: number; staged: number; total: number }
    >();
  ...
  copySessionId(sessionId: string) {
    ...
    if (typeof navigator !== 'undefined' && navigator.clipboard?.writeText) {
      navigator.clipboard
        .writeText(sessionId)
        .then(done)
        .catch(() => this.copyViaTextarea(sessionId, done));
      return;
    }
  ...
  exportSessionFiles(session: StagingSessionSummary) {
    this.backend
      .getStagingSessionFiles(session.sessionId, 0, 5000)
      .subscribe((filePage: { items: StageRecordView[] }) => {
  ...
  private buildFilesCsv(session: StagingSessionSummary, records: StageRecordView[]): string {
    ...
    const rows = records.map((r: StageRecordView) =>
      [
        ...
        .map((v: string | number) => this.csvEscape(v))
        .join(','),
    );
  ...
  private renderTrendChart() {
    ...
    const chart =
      echarts.getInstanceByDom(this.trendChartContainer!.nativeElement) ||
      echarts.init(this.trendChartContainer!.nativeElement, null, { renderer: 'canvas' });
  ...
  private renderStatusChart() {
    ...
    const option = {
      ...
      tooltip: {
        ...
        textStyle: { color: '#e2e8f0', fontSize: 12 },
        formatter: (params: any) =>
          `<div style="padding: 4px 0;"><strong>${params.name}</strong><br/>${params.value} files (${params.percent}%)</div>`,
      },
      legend: {
    ...
    const chart =
      echarts.getInstanceByDom(this.statusChartContainer!.nativeElement) ||
      echarts.init(this.statusChartContainer!.nativeElement, null, { renderer: 'canvas' });
    chart.setOption(option);
  }
