...
- [x] 6. Implement CpCompletionHandler
  ...
  - [x] 6.2 Implement checkCompletion() for CP stage
    ...
    - Map CpLogResult.Success → StageResult.completed() with metadata
    - Map CpLogResult.NotFound → StageResult.notFound()
    - Map CpLogResult.Failure → StageResult.error()
...
- [ ] 9. Implement core PipelineOrchestrator logic
  - [ ] 9.1 Create PipelineOrchestrator service with dependency injection
  ...
  - [ ] 9.2 Implement determineNextAction() method
  ...
  - [ ] 9.3 Implement areDependenciesSatisfied() private method
  ...
  - [ ] 9.4 Implement executeStage() method
  ...
  - [ ] 9.5 Implement progressToNextStage() method
  ...
  - [ ] 9.6 Implement keepInCurrentStage() method
    - Update last_stage_check_at timestamp
  ...
  - [ ] 9.7 Implement handleStageError() method
  ...
  - [ ] 9.8 Implement handleStageTimeout() method
...
- [ ] 10. Integrate orchestrator with CpLogMonitor
  - [ ] 10.1 Refactor CpLogMonitor.monitorEnrichmentRecords() to use orchestrator
  ...
  - [ ] 10.2 Update status names to use pipeline-aware names
...
- [ ] 11. Add PP_LOG monitoring scheduler
  - [ ] 11.1 Create PpLogMonitor scheduled service
  ...
  - [ ] 11.2 Configure poll interval in application.yml
...
- [ ] 12. Add REST API endpoints for pipeline status
  - [ ] 12.1 Create PipelineStatusController REST controller
    - Add @RestController annotation
    - Inject PipelineStatusTracker and PipelineConfigCache
    - _Requirements: 6.4_

  - [ ] 12.2 Implement GET /api/pipeline/status/{recordId} endpoint
  ...
  - [ ] 12.3 Implement POST /api/pipeline/retry/{recordId} endpoint
...
- [ ] 13. Add configuration validation at startup
  - [ ] 13.1 Create PipelineConfigValidator component
...
- [ ] 14. Add observability and metrics
  - [ ] 14.1 Add JMX metrics to PipelineOrchestrator
  ...
  - [ ] 14.2 Add structured logging for pipeline events
...
- [ ] 15. Add example pipeline configurations
  - [ ] 15.1 Document pipeline configuration in EXENSIO_API_DOCUMENTATION.md
  ...
  - [ ] 15.2 Add example configurations to dbconnections.yml comments
    - Add commented-out example for CP → PP_LOG → Exensio pipeline
...
- [ ] 16. Performance optimization
  - [ ] 16.1 Implement batch dependency checking
    - Group records by site before processing
    - Load pipeline config once per site batch
    - Process records in parallel within same site
    - _Requirements: 12.1, 12.3_

  - [ ] 16.2 Add thread pool configuration for stage processing
    - Add pipeline.thread-pool-size property to application.yml
    - Create ExecutorService for parallel stage checks
    - Use parallel streams or CompletableFuture for batch processing
    - _Requirements: 12.4_
