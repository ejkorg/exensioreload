package com.onsemi.cim.apps.exensio.resender.util;
...
class PasswordSanitizerTest {
    ...
    void sanitizeConfig_shouldNeverIncludePasswordInOutput() {
        ...
        com.onsemi.cim.apps.exensio.resender.config.EtlServerConfig config =
                new com.onsemi.cim.apps.exensio.resender.config.EtlServerConfig();
