...
import com.onsemi.cim.apps.exensio.exensioreload.config.DiscoveryProperties;
...
public class DiscoveryScheduler {
    ...
    public void scheduledDiscovery() {
        ...
        try {
            ...
            importer.discoverAndEnqueue(site, props.getEnvironment(), props.getSenderId(), props.getStartDate(), props.getEndDate(), props.getTesterType(), props.getDataType(), props.getDataTypeExt(), props.getTestPhase(), props.getLocation(), null, props.isWriteListFile(), props.getNumberOfDataToSend(), props.getCountLimitTrigger(), null);
        } catch (Exception ex) {
