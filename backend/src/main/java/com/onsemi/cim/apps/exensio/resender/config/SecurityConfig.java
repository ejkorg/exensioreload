...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http, JwtUtil jwtUtil,
        ...
        RequestMatcher apiMatcher = new AntPathRequestMatcher("/resender/api/**");
        ...
        delegatingEntryPoint.setDefaultEntryPoint(new LoginUrlAuthenticationEntryPoint("/resender/login"));
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/resender/api/**").authenticated()
