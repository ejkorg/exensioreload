...
import com.onsemi.cim.apps.exensio.resender.entity.SenderQueueEntry;
import com.onsemi.cim.apps.exensio.resender.repository.SenderQueueRepository;
import com.onsemi.cim.apps.exensio.resender.service.RefDbService;
import com.onsemi.cim.apps.exensio.resender.service.SenderDispatchService;
import com.onsemi.cim.apps.exensio.resender.service.SenderService;
import com.onsemi.cim.apps.exensio.resender.service.MailService;
import com.onsemi.cim.apps.exensio.resender.stage.DuplicatePayload;
import com.onsemi.cim.apps.exensio.resender.stage.PayloadCandidate;
import com.onsemi.cim.apps.exensio.resender.stage.StageResult;
import com.onsemi.cim.apps.exensio.resender.dto.DiscoveryPreviewRequest;
import com.onsemi.cim.apps.exensio.resender.dto.DiscoveryPreviewResponse;
import com.onsemi.cim.apps.exensio.resender.dto.DiscoveryPreviewRow;
import com.onsemi.cim.apps.exensio.resender.dto.DiscoveryPreviewWithDuplicatesResponse;
import com.onsemi.cim.apps.exensio.resender.dto.StageAllRequest;
import com.onsemi.cim.apps.exensio.resender.dto.StagePayloadRequest;
import com.onsemi.cim.apps.exensio.resender.dto.StagePayloadResponse;
import com.onsemi.cim.apps.exensio.resender.dto.DispatchRequest;
import com.onsemi.cim.apps.exensio.resender.dto.DispatchResponse;
import com.onsemi.cim.apps.exensio.resender.dto.DuplicatePayloadView;
import com.onsemi.cim.apps.exensio.resender.dto.EnqueueRequest;
import com.onsemi.cim.apps.exensio.resender.dto.HistoricalPreviewSummary;
...
public class SenderController {
    ...
    private final com.onsemi.cim.apps.exensio.resender.service.MetricsService metricsService;
    private final RefDbService refDbService;
    private final SenderDispatchService senderDispatchService;
    private final org.springframework.core.env.Environment env;
    private final com.onsemi.cim.apps.exensio.resender.repository.AppUserRepository userRepository;
    private final com.onsemi.cim.apps.exensio.resender.config.ExternalDbConfig externalDbConfig;
    private final MailService mailService;
    private final com.onsemi.cim.apps.exensio.resender.service.StageSessionService stageSessionService;

    public SenderController(SenderService senderService, SenderQueueRepository repo, com.onsemi.cim.apps.exensio.resender.service.MetadataImporterService metadataImporterService, com.onsemi.cim.apps.exensio.resender.service.MetricsService metricsService, RefDbService refDbService, SenderDispatchService senderDispatchService, org.springframework.core.env.Environment env, com.onsemi.cim.apps.exensio.resender.repository.AppUserRepository userRepository, com.onsemi.cim.apps.exensio.resender.config.ExternalDbConfig externalDbConfig, MailService mailService, com.onsemi.cim.apps.exensio.resender.service.StageSessionService stageSessionService) {
    ...
    public ResponseEntity<com.onsemi.cim.apps.exensio.resender.dto.EnqueueResult> enqueue(@PathVariable("id") Integer id, @RequestBody EnqueueRequest req) {
        Integer senderId = id;
        ...
        com.onsemi.cim.apps.exensio.resender.dto.EnqueueResult result = new com.onsemi.cim.apps.exensio.resender.dto.EnqueueResult(holder.enqueuedCount, holder.skippedPayloads, holder.pendingBefore, holder.pendingAfter);
    ...
    public ResponseEntity<String> discover(@PathVariable("id") Integer id,
        ...
        if (locationId != null && (site == null || site.equals("default") || site.isBlank())) {
            com.onsemi.cim.apps.exensio.resender.entity.ExternalLocation loc = metadataImporterService.findLocationById(locationId);
    ...
    public ResponseEntity<HistoricalPreviewSummary> historicalSummary(@PathVariable("id") Integer id,
        ...
        try {
            if (request.pairs() != null && !request.pairs().isEmpty()) {
                ...
                for (com.onsemi.cim.apps.exensio.resender.dto.DiscoveryPreviewPair p : request.pairs()) {
    ...
    public ResponseEntity<ByteArrayResource> previewCsv(@PathVariable("id") Integer id,
        ...
        java.util.List<com.onsemi.cim.apps.exensio.resender.dto.DiscoveryPreviewRow> collected = new java.util.ArrayList<>();
        ...
        try {
            while (true) {
                ...
                com.onsemi.cim.apps.exensio.resender.dto.DiscoveryPreviewResponse resp = metadataImporterService.previewMetadata(
        ...
        for (com.onsemi.cim.apps.exensio.resender.dto.DiscoveryPreviewRow r : collected) {
    ...
    public ResponseEntity<java.util.List<DuplicatePayloadView>> previewDuplicates(@PathVariable("id") Integer id,
                                                                                  @RequestBody com.onsemi.cim.apps.exensio.resender.dto.PreviewDuplicateRequest request) {
        if (request == null || request.items() == null || request.items().isEmpty()) {
            return ResponseEntity.ok(java.util.List.of());
        }
        Integer resolvedSender = request.senderId() != null ? request.senderId() : id;
        java.util.List<DuplicatePayloadView> out = new java.util.ArrayList<>();
        for (com.onsemi.cim.apps.exensio.resender.dto.PreviewDuplicateRequest.PreviewItem item : request.items()) {
            if (item == null) continue;
            String mid = item.metadataId();
            String did = item.dataId();
            com.onsemi.cim.apps.exensio.resender.stage.DuplicatePayload dup = refDbService.findDuplicatePayload(request.site(), resolvedSender, mid, did);
            if (dup != null) {
    ...
    public ResponseEntity<java.util.List<java.util.Map<String,Object>>> lookupSenders(@RequestParam(defaultValue = "default") String site,
        ...
        try {
            ...
            com.onsemi.cim.apps.exensio.resender.entity.ExternalLocation loc = null;
            ...
            try (java.sql.Connection c = conn) {
                ...
                java.util.List<com.onsemi.cim.apps.exensio.resender.repository.SenderCandidate> res = metadataImporterService.findSendersWithConnection(c, metadataLocation, dataType, testerType, dataTypeExt, testPhase);
                ...
                for (com.onsemi.cim.apps.exensio.resender.repository.SenderCandidate s : res) {
                ...
                if (resolvedCount == 1) {
                    ...
                    java.util.List<com.onsemi.cim.apps.exensio.resender.repository.SenderCandidate> sendersToReturn = null;
                    if (res != null && !res.isEmpty()) {
                        String tp = testPhase == null ? null : testPhase.trim();
                        String sn = senderName == null ? null : senderName.trim();
                        com.onsemi.cim.apps.exensio.resender.repository.SenderCandidate preferred = null;
                        // 1) senderName + testPhase
                        if (sn != null && !sn.isBlank() && tp != null && !tp.isBlank()) {
                            for (com.onsemi.cim.apps.exensio.resender.repository.SenderCandidate sc : res) {
                    ...
                    for (com.onsemi.cim.apps.exensio.resender.repository.SenderCandidate s : sendersToReturn) {
                        java.util.Map<String,Object> m = new java.util.HashMap<>();
                        m.put("idSender", s.getIdSender());
                        m.put("name", s.getName());
    ...
    public ResponseEntity<java.util.List<java.util.Map<String,Object>>> historicalSenders(@RequestParam(required = false, name = "locationId") Long locationId,
        ...
        try {
            ...
            try (java.sql.Connection c = conn) {
                ...
                java.util.List<com.onsemi.cim.apps.exensio.resender.repository.SenderCandidate> res = metadataImporterService.findHistoricalSendersWithConnection(c, dataType);
                java.util.List<java.util.Map<String,Object>> out = new java.util.ArrayList<>();
                for (com.onsemi.cim.apps.exensio.resender.repository.SenderCandidate s : res) {
                    java.util.Map<String,Object> m = new java.util.HashMap<>();
                    m.put("idSender", s.getIdSender());
    ...
    public ResponseEntity<java.util.List<java.util.Map<String,Object>>> externalSenders(@RequestParam(required = false, name = "locationId") Long locationId,
        ...
        try {
            ...
            try (java.sql.Connection c = conn) {
                ...
                java.util.List<com.onsemi.cim.apps.exensio.resender.repository.SenderCandidate> senders = metadataImporterService.findAllSendersWithConnection(c);
                ...
                java.util.List<java.util.Map<String,Object>> out = new java.util.ArrayList<>();
                for (com.onsemi.cim.apps.exensio.resender.repository.SenderCandidate s : senders) {
                    java.util.Map<String,Object> m = new java.util.HashMap<>();
                    m.put("idSender", s.getIdSender());
                    m.put("name", s.getName());
                    m.put("id", s.getIdSender());
