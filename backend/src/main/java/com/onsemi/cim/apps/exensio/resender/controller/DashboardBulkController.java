...
import com.onsemi.cim.apps.exensio.resender.dto.BulkOperationResult;
import com.onsemi.cim.apps.exensio.resender.dto.BulkSenderRequest;
...
public class DashboardBulkController {
    ...
    private static final List<String> CANCELLABLE_STATUSES = List.of("NEW", "FAILED");
    ...
    public ResponseEntity<BulkOperationResult> pause(@RequestBody BulkSenderRequest request) {
        ...
        for (int senderId : senderIds) {
            try {
                ...
                refDbService.bulkCancelBySender(senderId, List.of("NEW"));
                successCount++;
            } catch (Exception ex) {
