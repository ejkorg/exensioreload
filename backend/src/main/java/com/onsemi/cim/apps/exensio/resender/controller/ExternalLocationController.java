...
import com.onsemi.cim.apps.exensio.resender.service.ExternalLocationService;
...
public class ExternalLocationController {
    ...
    public ResponseEntity<String> importCsv(@RequestParam("file") MultipartFile file) throws IOException {
        String expected = com.onsemi.cim.apps.exensio.resender.config.ConfigUtils.getString(env, "external.import-token", "EXTERNAL_IMPORT_TOKEN", null);
