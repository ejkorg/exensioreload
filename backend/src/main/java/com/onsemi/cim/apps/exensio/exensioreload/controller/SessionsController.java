...
public class SessionsController {
    ...
    public String pushSessionToExternal(@PathVariable Long id) {
        ...
        java.util.List<com.onsemi.cim.apps.exensio.exensioreload.entity.SenderQueueEntry> items = new java.util.ArrayList<>();
        for (LoadSessionPayload p : payloads) {
            com.onsemi.cim.apps.exensio.exensioreload.entity.SenderQueueEntry e = new com.onsemi.cim.apps.exensio.exensioreload.entity.SenderQueueEntry(s.getSenderId(), p.getPayloadId(), s.getSource());
            items.add(e);
        }
