...
public class LoadSession {
    ...
    private String userEmail; // Email address for completion notifications
    private Boolean notificationSent = false; // Track if completion notification was sent
    private Instant notificationSentAt; // When notification was sent
    private Instant lastCheckedAt; // Last time we checked external queue for completion
